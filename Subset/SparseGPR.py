...
from GPy.inference.latent_function_inference import VarDTC, FITC
...
class SparseGPRegression(SparseGP_MPI):
    ...
    def __init__(self, X, Y, kernel=None, Z=None, num_inducing=10, X_variance=None, mean_function=None, normalizer=None, mpi_comm=None, name='sparse_gp', sparse_method='FITC'):
        ...
        if sparse_method=='FITC':
            infr = FITC()
        elif sparse_method=='VDTC':
            infr = VarDTC()
    ...
    def parameters_changed(self):
        from GPy.inference.latent_function_inference.var_dtc_parallel import update_gradients_sparsegp,VarDTC_minibatch
